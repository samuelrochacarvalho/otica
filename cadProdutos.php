        ...
        <input type="hidden" name="tabela" id="tabela" value="produto"class="form-control">
          <div class=" shadow p-3 mb-5 bg-body-tertiary rounded container">
            ...
            <div class="form-group">
              <label for="nomeP">Nome:
                <input type="text" name="nomeP" id="nomeP" placeholder="Digite o Nome do Produto" class="form-control">
              </label>
            </div>
            <div class="form-group">
              <div class="row">
                <div class="col-4">
                  <label for="referencia">Referencia:
                    <input type="text" name="referencia" id="referencia" placeholder="Referencia da Armação" class="form-control">
                  </label>
                </div>
                <div class="col-4">
                  <label for="codigo">Código GTIN (EAN-13):
                    <input type="text" name="codigo" id="codigo" placeholder="Codigo de Barras" class="form-control">
                  </label>
                </div>
                <div class="col-4">
                  <label for="unidade">Unidade:
                    <input type="text" name="unidade" id="unidade" placeholder="UN" class="form-control">
                  </label>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col=3">
                <label for="fornecedor">Fornecedores:
                  <input type="text" name="fornecedor" id="fornecedor" placeholder="Digite o fornecedor" class="form-control">
                </label>
              </div>
            </div>
          ...
          <div class=" shadow p-3 mb-5 bg-body-tertiary rounded container">
            ...
            <table class="table table-success table-striped-columns">
              ...
              <tbody>
                <tr>
                  <td><input type="text" id="custo" name="custo" class="form-control" placeholder="0,00"></td>
                  <td><input type="text" id="Plucro" name="Plucro" class="form-control" placeholder="0 %"></td>
                  <td><input type="text" id="lucro" name="lucro" class="form-control" placeholder="0,00 R$"></td>
                  <td><input type="text" id="venda" name="venda" class="form-control" placeholder="0,00 R$"></td>
                  <td><input type="text" id="qatual" name="qatual" class="form-control" placeholder="0"></td>
                </tr>
              </tbody>
            </table>
